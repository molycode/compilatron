...
show_usage() {
    ...
    echo "  - Full path to executable: /home/user/compilers/gcc_16/bin/g++"
    echo "  - Directory path: /home/user/compilers/gcc_16 (finds g++/clang++ automatically)"
    echo "  - Directory with bin: /home/user/compilers/gcc_16/bin"
    echo ""
    ...
    echo "  $0 --compiler /home/user/compilers/gcc_16      # Use directory (finds g++ automatically)"
